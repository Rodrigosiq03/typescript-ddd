...
export class ProductRepositoryMock implements IProductRepository {
  private products: Product[] = [
    new Product(
      ...
      new UniqueEntityID("331c425e-4f72-4e82-ad68-bf552f500750")
    ),
    new Product(
      { name: "Produto 2", size: "G", color: "Vermelho", quantity: 5, minimumQuantity: 1 },
      new UniqueEntityID("ef0aecde-c9eb-48b6-8b1f-c95737f33f68")
    ),
    new Product(
      { name: "Produto 3", size: "P", color: "Verde", quantity: 20, minimumQuantity: 5 },
      new UniqueEntityID("2f8c6175-ef97-485d-b7a5-503fd57426fa")
    ),
    new Product(
      { name: "Produto 4", size: "GG", color: "Preto", quantity: 15, minimumQuantity: 3 },
      new UniqueEntityID("d2c8e1f0-4b6f-4c3a-bb5d-9d0e1f9c7a6b")
    ),
    new Product(
      { name: "Produto 5", size: "M", color: "Branco", quantity: 8, minimumQuantity: 2 },
      new UniqueEntityID("a1b2c3d4-e5f6-7890-abcd-ef1234567890")
    ),
    new Product(
      { name: "Produto 6", size: "G", color: "Cinza", quantity: 12, minimumQuantity: 4 },
      new UniqueEntityID("12345678-90ab-cdef-1234-567890abcdef")
    )
  ];
